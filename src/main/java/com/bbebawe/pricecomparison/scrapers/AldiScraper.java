...
public class AldiScraper extends Scraper{
    ...
    public void scrape() throws IOException {
        System.out.println(" =========== Aldi Scrapper Started ===========");
//        startScraping();
    ...
    public void startScraping() throws IOException {
        ...
        for (Product product : productList) {
            ...
            Elements scrapedProducts = doc.select(".category-grid--search  .category-item__title");
            Elements scrapedPrices = doc.select(".category-grid--search .category-item__price");
            Elements scrapedImages = doc.select("#productLister .category-item__image img");
